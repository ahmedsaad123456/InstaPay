...
public abstract class Registration {
    public boolean signUp(User userData){
        ...
        boolean isNotMobileNumber = true ;
        ...
        while (invaildInfo){
            ...
            if(!specificSignUp(userData , mobileNumber)){
                char c;
    ...
    public abstract boolean specificSignUp(User userData , String mobileNumber);
}
